  ...
  return (
    <div className="container-showcase">
      ...
      <div className="showcase-right">
        ...
        />
        <iframe className="video" src="https://streamable.com/e/lqvk1t?autoplay=1&nocontrols=1" style={{ border: "none", borderRadius: "2px" }} width="530" height="260" allow="autoplay"></iframe>
      </div>
    </div>
  );
}
